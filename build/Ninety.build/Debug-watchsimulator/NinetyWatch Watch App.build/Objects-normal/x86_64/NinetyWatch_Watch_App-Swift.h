...
#ifndef NINETYWATCH_WATCH_APP_SWIFT_H
#define NINETYWATCH_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NinetyWatch_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21NinetyWatch_Watch_App16WatchAppDelegate")
@interface WatchAppDelegate : NSObject <WKApplicationDelegate>
- (void)applicationDidFinishLaunching;
- (void)applicationDidBecomeActive;
- (void)handleExtendedRuntimeSession:(WKExtendedRuntimeSession * _Nonnull)extendedRuntimeSession;
- (void)handleBackgroundTasks:(NSSet<WKRefreshBackgroundTask *> * _Nonnull)backgroundTasks;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC21NinetyWatch_Watch_App18WatchSensorManager")
@interface WatchSensorManager : NSObject <WCSessionDelegate, WKExtendedRuntimeSessionDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class WCSession;
@class NSString;
@interface WatchSensorManager (SWIFT_EXTENSION(NinetyWatch_Watch_App))
